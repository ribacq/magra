#############################################################################
# Makefile for building: magra
# Generated by qmake (3.1) (Qt 5.9.6)
# Project:  magra.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile magra.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = magra1.0.0
DISTDIR = /home/jirsad/Documents/cpp/magra/.tmp/magra1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: magra.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents group.h gui.h word.h $(DISTDIR)/
	$(COPY_FILE) --parents group.cpp gui.cpp main.cpp word.cpp $(DISTDIR)/
